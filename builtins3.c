...
/**
 * _mul - multiplies the top eand second element of the stack
 *
 * @doubly: head of the lined list
 * @cline: line number;
 * Return: no return
 */
...
/**
 * _mod - returns the remainder of the division of the second
...
/**
 * _pchar - prints the char of the first element
 * @doubly: head of the linked list
 * @cline: line number
 *
 * Return: NULL
